<template>
  <div class="sticky top-0 z-50 backdrop-blur-md bg-background/70 p-4 border-b">
    <div class="container mx-auto">
      <NavigationMenu>
        <NavigationMenuList>
          ...
          <NavigationMenuItem class="ml-3" v-for="(group, index) in groups" :key="index">
            <NavigationMenuTrigger class="font-bold text-md">{{ group.id }}</NavigationMenuTrigger>
            <NavigationMenuContent>
              <ul
                class="grid w-[350px] gap-2 p-2 md:w-[500px] md:grid-cols-2 lg:w-[720px] lg:grid-cols-3"
              >
