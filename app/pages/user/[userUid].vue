...
import { nuboProfileKey } from "~/types/nubo-skin-keys"
...
provide(nuboProfileKey, {
  ...
  updateMyProfile: async () => {
    if (auth.editProfile.password1.length > 0 || auth.editProfile.password2.length > 0) {
      ...
      if (!pwRegex.test(auth.editProfile.password1) || !pwRegex.test(auth.editProfile.password2)) {
