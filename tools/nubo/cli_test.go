...
func TestCLIHelpIsUsefulWithoutTTY(t *testing.T) {
	...
	for _, expected := range []string{"./bin/nubo search", "./bin/nubo info skins/<key>", "./bin/nubo install skins/<key>", "./bin/nubo validate skins/<key>", "./bin/nubo pack skins/<key>", "./bin/nubo download", "./bin/nubo update", "자동으로 변경하지 않습니다"} {
