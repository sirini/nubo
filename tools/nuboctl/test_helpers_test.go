...
func createInstallTestReleaseVersion(t *testing.T, releaseDir, version string) {
	...
	files := map[string]string{
		...
		"share/env.sample": strings.Join([]string{
			"GOAPI_VERSION=" + version, "NUXT_PUBLIC_VERSION=" + version,
